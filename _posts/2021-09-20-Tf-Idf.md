...
In Machine Learning, it is nice when models are simple and interpretable because it reduces the burden of debugging a complex model when things don't work. But simple models do not always lead to the best results.
