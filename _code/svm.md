---
layout: code
title: Support Vector Machine Using Pytorch
...
class SVM:
    ...
    def fit(self, X, y, max_epochs):
        """
        * First, Iterating over epochs range.
        * Running a Stochastic Gradient Descent, meaning updating weights after each records is passed through the
        model.
        :param X: Input Tensor
