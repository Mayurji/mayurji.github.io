...
<center>
<img src="{{site.url}}/assets/images/dsa/recursion_traverse.png" style="zoom: 5%; background-color:#DCDCDC;" width="80%" height=auto/><br>
...
The **base condition** of recursion is not satisfied, until all the nodes are traversed, **if root:** condition is true, means all nodes are traversed.
