...
---
In this blog post, we'll discuss three data structures stack, queue and heap.

### Stack

Data structure where we arrange data elements like a stack of plates and which can be accessed only on the top are called **Stack**.

* In stack, we can add element only at the top. (Insertion)
* In stack, we can remove element that present only on the top.
...
<center>
<img src="{{site.url}}/assets/images/dsa/Lifo_stack.png" style="zoom: 5%; background-color:#DCDCDC;"/><br>
<p>Figure 2: Stack</p> 
</center>
...
<center>
<img src="{{site.url}}/assets/images/dsa/queue.png" style="zoom: 5%; background-color:#DCDCDC;"/><br>
<p>Figure 3: Queue</p> 
</center>
...
<center>
<img src="{{site.url}}/assets/images/dsa/max_min_heap.png" style="zoom: 5%; background-color:#DCDCDC;"/><br>
...
<center>
<img src="{{site.url}}/assets/images/dsa/heapify.png" style="zoom: 5%; background-color:#DCDCDC;"/><br>
