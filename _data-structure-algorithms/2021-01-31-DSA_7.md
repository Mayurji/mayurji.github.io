## Binary Tree and its variants

In this blog post, we'll discuss about binary tree and it's different variants along with python implementation. 
...
To avoid overwhelming of trees, we'll continue with other structure like binary search tree, AVL tree etc in the next blog.