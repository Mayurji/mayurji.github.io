...
description: Efficient Search Tree 
date:   2021-01-31 13:43:52 +0530
---
{% include mathjax.html %}
## Data Structure in Python - Binary Tree

In this blog post, we'll discuss about binary tree and its different variants along with python implementation. In previous post, we learnt about trees and its properties, which are relevant to binary tree as well.
...
<center>
<img src="{{site.url}}/assets/images/dsa/variant_BT.png.png" style="zoom: 5%; background-color:#DCDCDC;" width="80%" height=auto/><br>
<p>Figure 2: Different Variants of Binary Tree</p> 
</center>
...
I've discussed in binary heap discussion, how the position (index) of an node can be calculate from any node. Lets rewind a bit !
